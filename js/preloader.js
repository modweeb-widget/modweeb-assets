// ========================================
// MODWEEB DESIGN - PRELOADER COMPONENT
// Version: 1.0.0
// ========================================
...
(function() {
    ...
    // ===== [2] دالة إضافة Preloader إلى الصفحة =====
    function addPreloader() {
        // البحث عن حاوية preloader
        const container = document.getElementById('preloader-container');
        
        if (container) {
            // إذا وجدت الحاوية، أضف Preloader داخلها
            container.innerHTML = PRELOADER_HTML;
        } else {
            // إذا لم توجد حاوية، أضف Preloader في بداية body
            const tempDiv = document.createElement('div');
            tempDiv.innerHTML = PRELOADER_HTML;
